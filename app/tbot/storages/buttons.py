...
BUTTONS_TEMPLATES = \
    {
        ...
        'review_form_project_delete_choose_contact': ButtonTemplate('review_form_project_delete_choose_contact', 'Удалить'),
        'review_form_project_edit_choose_contact': ButtonTemplate('review_form_project_edit_choose_contact', 'Изменить'),
        'review_form_add_contact_in_current_project': ButtonTemplate('review_form_add_contact_in_current_project', 'Добавить'),
