...
BUTTONS_TEMPLATES = \
    {
        ...
        'review_form_duties_list': ButtonTemplate('review_form_duties_list', 'Обязанности'),
        'review_form_back_duties': ButtonTemplate('review_form_duties_list', '« К обязанностям'),
        'review_form_duties_add': ButtonTemplate('review_form_duties_add', 'Добавить'),
        'review_form_duty_delete': ButtonTemplate('review_form_duty_delete'),
        'review_form_duty_edit': ButtonTemplate('review_form_duty_edit'),
        'review_form_duties_delete_choose': ButtonTemplate('review_form_duties_delete_choose', 'Удалить'),
        'review_form_duties_edit_choose': ButtonTemplate('review_form_duties_edit_choose', 'Изменить'),
        'review_form_project_delete_contact': ButtonTemplate('review_form_project_delete_contact'),
        ...
        'review_form_project_delete_choose': ButtonTemplate('review_form_project_delete_choose', 'Удалить проект'),
        'review_form_project_edit_choose': ButtonTemplate('review_form_project_edit_choose', 'Изменить проект'),
        ...
        'review_form_project_contacts': ButtonTemplate('review_form_project_contacts', 'Контакты'),
        'review_form_project_add_contact': ButtonTemplate('review_form_project_add_contact', 'Добавить'),
        'review_form_project_delete_choose_contact': ButtonTemplate('review_form_project_delete_choose_contact',
                                                                    'Удалить'),
        'review_form_project_edit_choose_contact': ButtonTemplate('review_form_project_edit_choose_contact',
                                                                  'Изменить'),
        'review_form_add_contact_in_current_project': ButtonTemplate('review_form_add_contact_in_current_project',
                                                                     'Добавить'),
        'review_form_project_edit_contact': ButtonTemplate('review_form_project_change_contact'),
        'review_form_project_contacts_back': ButtonTemplate('review_form_project_contacts', '« Назад'),
        'review_form_project_edit_back': ButtonTemplate('review_form_project_edit', '« Назад'),
        ...
        'coworker_choose_rate': ButtonTemplate('coworker_choose_rate', 'Поставить оценку'),
