    ...
    def create_message(self) -> str:
        ...
        if self.args.get('is_name'):
            ...
            description = 'Привет, я бот Марк.\n\n' \
                    'Я помогу тебе пройти <b>Performance review</b>: обзор эффективности работы сотрудника за определенный период времени. Этот инструмент позволяет  выявить “слабые” и “сильные” места в компании и повысить  эффективность работы организации в целом.' \
