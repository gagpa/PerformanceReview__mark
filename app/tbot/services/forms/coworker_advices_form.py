    ...
    def create_message(self) -> str:
        ...
        if view == 'list':
            ...
            if coworker_advices:
                ...
                if advice_type == 'todo':
                    description = '\n❕ Сначала нажми кнопку «Добавить» и напиши все советы и пожелания коллеге одним текстом через «;». Если что-то забудешь, позже можно это исправить.'
                elif advice_type == 'not todo':
                    description = '\n❕ Сначала нажми кнопку «Добавить» и напиши что стоит перестать делать коллеге одним текстом через «;». Если что-то забудешь, позже можно это исправить.'
                else:
                    description = '\n❕ Сначала нажми кнопку «Добавить» и напиши все советы и пожелания коллеге одним текстом через «;». Если что-то забудешь, позже можно это исправить.'
